package com.funo.mq.demo.AMQinAction.ch4.portfolio;
...
public class Publisher {
    ...
    public static void main(String[] args) throws JMSException {
    	String[] args2={ "tcp://localhost:61616","CSCO","ORCL"};
    	if (args2.length == 0) {
    	...
    	Publisher publisher = new Publisher(args2[0]);


    	//extract topics from the rest of arguments
    	String[] topics = new String[args2.length - 1];
    	System.arraycopy(args2, 1, topics, 0, args2.length - 1);
        while (total < 1000) {
